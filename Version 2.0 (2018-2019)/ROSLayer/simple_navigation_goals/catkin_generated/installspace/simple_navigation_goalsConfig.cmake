...
if("FALSE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/johnchen/catkin_ws/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/johnchen/catkin_ws/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/johnchen/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'john <john@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/johnchen/catkin_ws/install/${idir}'.  Ask the maintainer 'john <john@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/johnchen/catkin_ws/install/lib;/home/johnchen/catkin_ws/devel/lib;/opt/ros/hydro/lib)
