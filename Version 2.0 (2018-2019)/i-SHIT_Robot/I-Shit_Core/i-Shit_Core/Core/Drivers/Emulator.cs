...
namespace i_Shit_Core.Core.Drivers
{
    public static partial class Driver
    {
        ...
        internal static int Emulator_Total_Index_Face_RosLocation = 0;
        ...
        internal static void Emulator_Hand_GoUp(int distance)
        {
            ...
            Thread.Sleep(1000);
            Console.WriteLine("Emulator: Hand GoUp: " + distance);
        }
        ...
        internal static void Emulator_Hand_GoDown(int distance)
        {
            ...
            Thread.Sleep(1000);
            Console.WriteLine("Emulator: Hand GoDown: " + distance);
        }
        ...
        internal static void Emulator_Hand_Close(byte distance)
        {
            ...
            Thread.Sleep(1000);
            Console.WriteLine("Emulator: Hand Close: " + distance);
        }
        ...
        internal static void Emulator_Hand_Open(byte distance)
        {
            ...
            Thread.Sleep(1000);
            Console.WriteLine("Emulator: Hand Open: " + distance);
        }
        //--Hand
