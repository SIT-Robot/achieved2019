    ...
    public static partial class Function
    {
        ...
        public static LocationInfo Location_GetLocationInfoByName(string name)
        {
            try
            {
                ...
                Console.WriteLine("Location Error: " + name + " is not in database.");
        ...
        public static LocationInfo Location_GetCurrectLocationFromRos()
        {
            ...
            {
                Driver.Emulator_Total_Index_Face_RosLocation++;
                LocationInfo LI2 = new LocationInfo();
                LI2._locationName = "Fake ROS Location " + Driver.Emulator_Total_Index_Face_RosLocation;
                LI2._positionX = 10f;
                LI2._positionY = 11f;
                LI2._positionZ = 0;
                LI2._orientationX = 0;
