...
/*
 把这个文件
 BodyWindow body_window_ins = new BodyWindow();
 body_window_ins.Show()
 就可以跳出Kinect骨架窗口
 */
using System;
...
namespace i_Shit_Core
{
    ...
    /// </summary>
    public partial class BodyWindow : Window, INotifyPropertyChanged
    {
        ...
        public Publisher BodyPublisher = new Publisher();
