...
namespace i_Shit_Core
{
    ...
    /// </summary>
    public partial class BodyDetectWindow : Window, INotifyPropertyChanged
    {
        ...
        public UserTracker userTracker = new UserTracker();


        private List<GestureDetector> gestureDetectorList = null;

        public void startUserTracker(ref UserTracker _UserTracker)
        {
            //usetracker 实例化
        ...
        private void BodyDetectWindow_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        /// <param name="sender">object sending the event</param>
        /// <param name="e">event arguments</param>
        private void BodyDetectWindow_Closing(object sender, CancelEventArgs e)
        {
            ...
            if (dataReceived)
            {
                using (DrawingContext dc = drawingGroup.Open())
                {
                    ...
                    foreach (Body body in bodies)
                    {
                        ...
                        {
                            //jia
                            userTracker.addUserBody(body, this.gestureDetectorList[i].GestureResultView.Detected,
                                this.gestureDetectorList[i].GestureResultView.Confidence);
                    ...
                    userTracker.bodyReady();

                    //userTracker.UserChoicer(TrackerType.middleUser,ref speedStr);
