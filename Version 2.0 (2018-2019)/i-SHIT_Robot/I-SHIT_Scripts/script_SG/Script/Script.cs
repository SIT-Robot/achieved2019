...
namespace i_Shit_Scirpt.Script
{
    public class MyScript : Scripts
    {
        ...
        public override void Script_Process()
        {
            ...
            Function.Hand_GoUp(420);

            FuckStuff("cola");
            FuckStuff("grapejuice");
            FuckStuff("beer");
            FuckStuff("red chips");
            FuckStuff("milktea");
            ...
            FuckStuff("green shampoo");

            FuckStuff("blue shampoo");

            FuckStuff("yellow shampoo");
        ...
        public void StartFucking()
        {
            ...
            Function.Move_Navigate(Function.Location_GetLocationInfoByName("kitchen"))
                ;
